...
and КрутитьОбъект () =
   for i = iMin to iMax-1 do
     ...
     let д = Math.КвадратныйКорень(float (Math.Степень(tx - x, 2) + Math.Степень(ty - y, 2))) |> int
