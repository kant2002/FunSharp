...
let цвет = dict [1,Цвета.Оранжевый; 2, Цвета.Cyan; 3, Цвета.Lime]
...
and КрутитьОбъект () =
   for i = iMin to iMax-1 do
     ...
     let д = Математика.КвадратныйКорень(float (Математика.Степень(tx - x, 2) + Математика.Степень(ty - y, 2))) |> int
