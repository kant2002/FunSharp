...
and создать_уровень1 () =  // this define the behavior of the différent squadron along the time play for level 1
   ...
   for i=1 to 10 do
      ...
      уровень1.[18+i].[4] <- i
      уровень1.[18+i].[5] <- 1
      уровень1.[18+i].[6] <- Math.GetRandomNumber(3)
   ...
   for i= 1 to 10 do
      ...
      уровень1.[28+i].[4] <- i
      уровень1.[28+i].[5] <- 1
      уровень1.[28+i].[6] <- Math.GetRandomNumber(3)
   ...
   for i= 1 to 10 do
     ...
     уровень1.[38+i].[5] <- Math.GetRandomNumber(2)
     уровень1.[38+i].[6] <- Math.GetRandomNumber(5)
     уровень1.[38+i].[7] <- Math.GetRandomNumber(2)
