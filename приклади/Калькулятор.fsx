...
ГрафичнеВікно.Ширина <- 260
ГрафичнеВікно.Высота <- 230
ГрафичнеВікно.Заголовок <- "Калькулятор v. 1.0 от Alex_2000"
...
let T1 = T0 + (139-58)*N
let T2 = T1 + (202-139)*N 
ГрафичнеВікно.ЦветКисти <- Кольори.Red
...
ГрафичнеВікно.ЦветКисти <- Кольори.Blue
