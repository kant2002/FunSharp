...
let т = ЭлементиКерування.ДодатиТекстовеВікно(10, 10)
...
let T1 = T0 + (139-58)*N
let T2 = T1 + (202-139)*N 
ГрафичнеВікно.КолірПензлика <- Кольори.Червоний
let кнопкаMC = ЭлементиКерування.ДодатиКнопку("MC", C0, R1)
ЭлементиКерування.ВстановитиРозмір(кнопкаMC, 35*N, 25*N)
let кнопкаMR = ЭлементиКерування.ДодатиКнопку("MR", C0, R2)
ЭлементиКерування.ВстановитиРозмір(кнопкаMR, 35*N, 25*N)
let кнопкаMS = ЭлементиКерування.ДодатиКнопку("MS", C0, R3)
ЭлементиКерування.ВстановитиРозмір(кнопкаMS, 35*N, 25*N)
let кнопкаMплюс = ЭлементиКерування.ДодатиКнопку("M+", C0, R4)
ЭлементиКерування.ВстановитиРозмір(кнопкаMплюс, 35*N, 25*N)
let кнопкаC = ЭлементиКерування.ДодатиКнопку("C", T2, R0)
ЭлементиКерування.ВстановитиРозмір(кнопкаC, 55*N, 25*N )
let кнопкаCE = ЭлементиКерування.ДодатиКнопку("CE", T1, R0)
ЭлементиКерування.ВстановитиРозмір(кнопкаCE, 55*N, 25*N)
let кнопкаСтереть = ЭлементиКерування.ДодатиКнопку("Backspace", T0, R0)
ЭлементиКерування.ВстановитиРозмір(кнопкаСтереть, 70*N, 25*N)

let кнопкаделение = ЭлементиКерування.ДодатиКнопку("/", C4, R1)
ЭлементиКерування.ВстановитиРозмір(кнопкаделение, 35*N, 25*N)
let кнопкаумножение = ЭлементиКерування.ДодатиКнопку("*", C4, R2)
ЭлементиКерування.ВстановитиРозмір(кнопкаумножение, 35*N, 25*N)
let кнопкаминус = ЭлементиКерування.ДодатиКнопку("-", C4, R3)
ЭлементиКерування.ВстановитиРозмір(кнопкаминус, 35*N, 25*N)
let кнопкаплюс = ЭлементиКерування.ДодатиКнопку("+", C4, R4)
ЭлементиКерування.ВстановитиРозмір(кнопкаплюс, 35*N, 25*N)
let кнопкаравно = ЭлементиКерування.ДодатиКнопку("=", C5, R4)
ЭлементиКерування.ВстановитиРозмір(кнопкаравно, 35*N, 25*N)

ГрафичнеВікно.КолірПензлика <- Кольори.Синій
let кнопка7 = ЭлементиКерування.ДодатиКнопку("7", C1, R1)
ЭлементиКерування.ВстановитиРозмір(кнопка7, 35*N, 25*N)
let кнопка8 = ЭлементиКерування.ДодатиКнопку("8", C2, R1)
ЭлементиКерування.ВстановитиРозмір(кнопка8, 35*N, 25*N)
let кнопка9 = ЭлементиКерування.ДодатиКнопку("9", C3, R1)
ЭлементиКерування.ВстановитиРозмір(кнопка9, 35*N, 25*N)
let кнопка4 = ЭлементиКерування.ДодатиКнопку("4", C1, R2)
ЭлементиКерування.ВстановитиРозмір(кнопка4, 35*N, 25*N)
let кнопка5 = ЭлементиКерування.ДодатиКнопку("5", C2, R2)
ЭлементиКерування.ВстановитиРозмір(кнопка5, 35*N, 25*N)
let кнопка6 = ЭлементиКерування.ДодатиКнопку("6", C3, R2)
ЭлементиКерування.ВстановитиРозмір(кнопка6, 35*N, 25*N)
let кнопка1 = ЭлементиКерування.ДодатиКнопку("1", C1, R3)
ЭлементиКерування.ВстановитиРозмір(кнопка1, 35*N, 25*N)
let кнопка2 = ЭлементиКерування.ДодатиКнопку("2", C2, R3)
ЭлементиКерування.ВстановитиРозмір(кнопка2, 35*N, 25*N)
let кнопка3 = ЭлементиКерування.ДодатиКнопку("3", C3, R3)
ЭлементиКерування.ВстановитиРозмір(кнопка3, 35*N, 25*N)
let кнопка0 = ЭлементиКерування.ДодатиКнопку("0", C2, R4)
ЭлементиКерування.ВстановитиРозмір(кнопка0, 35*N, 25*N)

let кнопкаплюсминус = ЭлементиКерування.ДодатиКнопку("+/-", C3, R4)
ЭлементиКерування.ВстановитиРозмір(кнопкаплюсминус, 35*N, 25*N)
let кнопкаточка = ЭлементиКерування.ДодатиКнопку(".", C1, R4)
ЭлементиКерування.ВстановитиРозмір(кнопкаточка, 35*N, 25*N)

let кнопкакорень = ЭлементиКерування.ДодатиКнопку("sqrt", C5, R1)
ЭлементиКерування.ВстановитиРозмір(кнопкакорень, 35*N, 25*N)
let keyprocent = ЭлементиКерування.ДодатиКнопку("%", C5, R2)
ЭлементиКерування.ВстановитиРозмір(keyprocent, 35*N, 25*N)
let кнопканаХ = ЭлементиКерування.ДодатиКнопку("1/x", C5, R3)
