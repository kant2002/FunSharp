...
let нажато () =
  ...
  if ЭлементыУправления.ПоследняяКликнутаяКнопка = кнопка0 then
    ЭлементыУправления.УстановитьТекстТекстовогоПоля(т, Текст.Додати(ЭлементыУправления.ПолучитьТекстТекстовогоПоля(т), "0"))
  elif ЭлементыУправления.ПоследняяКликнутаяКнопка = кнопка1 then
    ЭлементыУправления.УстановитьТекстТекстовогоПоля(т, Текст.Додати(ЭлементыУправления.ПолучитьТекстТекстовогоПоля(т), "1"))
  elif ЭлементыУправления.ПоследняяКликнутаяКнопка = кнопка2 then
    ЭлементыУправления.УстановитьТекстТекстовогоПоля(т, Текст.Додати(ЭлементыУправления.ПолучитьТекстТекстовогоПоля(т), "2"))
  elif ЭлементыУправления.ПоследняяКликнутаяКнопка = кнопка3 then
    ЭлементыУправления.УстановитьТекстТекстовогоПоля(т, Текст.Додати(ЭлементыУправления.ПолучитьТекстТекстовогоПоля(т), "3"))
  elif ЭлементыУправления.ПоследняяКликнутаяКнопка = кнопка4 then
    ЭлементыУправления.УстановитьТекстТекстовогоПоля(т, Текст.Додати(ЭлементыУправления.ПолучитьТекстТекстовогоПоля(т), "4"))
  elif ЭлементыУправления.ПоследняяКликнутаяКнопка = кнопка5 then
    ЭлементыУправления.УстановитьТекстТекстовогоПоля(т, Текст.Додати(ЭлементыУправления.ПолучитьТекстТекстовогоПоля(т), "5"))
  elif ЭлементыУправления.ПоследняяКликнутаяКнопка = кнопка6 then
    ЭлементыУправления.УстановитьТекстТекстовогоПоля(т, Текст.Додати(ЭлементыУправления.ПолучитьТекстТекстовогоПоля(т), "6"))
  elif ЭлементыУправления.ПоследняяКликнутаяКнопка = кнопка7 then
    ЭлементыУправления.УстановитьТекстТекстовогоПоля(т, Текст.Додати(ЭлементыУправления.ПолучитьТекстТекстовогоПоля(т), "7"))
  elif ЭлементыУправления.ПоследняяКликнутаяКнопка = кнопка8 then
    ЭлементыУправления.УстановитьТекстТекстовогоПоля(т, Текст.Додати(ЭлементыУправления.ПолучитьТекстТекстовогоПоля(т), "8"))
  elif ЭлементыУправления.ПоследняяКликнутаяКнопка = кнопка9 then
    ЭлементыУправления.УстановитьТекстТекстовогоПоля(т, Текст.Додати(ЭлементыУправления.ПолучитьТекстТекстовогоПоля(т), "9"))
  elif ЭлементыУправления.ПоследняяКликнутаяКнопка = кнопкаточка then
    ЭлементыУправления.УстановитьТекстТекстовогоПоля(т, Текст.Додати(ЭлементыУправления.ПолучитьТекстТекстовогоПоля(т), "."))
    ...
    ЭлементыУправления.УстановитьТекстТекстовогоПоля(т, Текст.ОтриматиЧастинуТекста(ЭлементыУправления.ПолучитьТекстТекстовогоПоля(т), 1, Текст.ОтриматиДовжину(ЭлементыУправления.ПолучитьТекстТекстовогоПоля(т))-1))
