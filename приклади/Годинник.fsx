...
нехай инициализуватиВікно () =
   ...
   for angle in 1.0..180.0 зробити
...
нехай встановитиСтрілки () = 
   якщо (float Годинник.Година + float Годинник.Хвилина/60. + float Годинник.Секунда/3600. <> Година) then
   ...
   якщо float Годинник.Хвилина <> Хвилина then
   ...
   якщо float Годинник.Секунда <> Секунда then
