...
нехай колір = dict [1,Кольори.Orange; 2, Кольори.Cyan; 3, Кольори.Lime]
нехай розмір = dict [1,20; 2,16; 3,12]
нехай змінливий рахунок = "<shape name>"
нехай змінливий iMin = 0
нехай змінливий iMax = 0
/// Falling object
тип Об'єкт = { змінливий X:int; змінливий Y:int; Род:int; НазваФігури:string }
/// Falling objects
...
та Гра () =
   ...
   iMin <- 0
   доки not виявленоЗіткнення зробити
     якщо рухається тоді
