...
and Движение  () =
   ...
   for i = 0 to количествоАстероидов-1 do
     let x = Математика.Залишок(Фігури.ОтриматиЛіво(астероид.[i]) + (Математика.Кос(Математика.ОтриматиРадіани(уголАстероида.[i] - 90.0)) * скоростьАстероидов) + ширинаГри, ширинаГри)
     let y = Математика.Залишок(Фігури.ОтриматиВерх(астероид.[i]) + (Математика.Син(Математика.ОтриматиРадіани(уголАстероида.[i] - 90.0)) * скоростьАстероидов) + высотаГри, высотаГри)
     Фігури.Перемістити(астероид.[i], x, y)

   // Move ammo
   for i = 0 to количествоПуль-1 do
     let x = Математика.Залишок(Фігури.ОтриматиЛіво(пуля.[i]) + (Математика.Кос(Математика.ОтриматиРадіани(уголПули.[i] - 90.0)) * скоростьПули) + ширинаГри, ширинаГри)
     let y = Математика.Залишок(Фігури.ОтриматиВерх(пуля.[i]) + (Математика.Син(Математика.ОтриматиРадіани(уголПули.[i] - 90.0)) * скоростьПули) + высотаГри, высотаГри)
...
and ПроверкаСтолкновений () =
   ...
   px1 <- Фігури.ОтриматиЛіво(ігрок) - ( (Математика.Модуль(ширинаИгрока * Математика.Кос(Математика.ОтриматиРадіани(кутІгрока)) + высотаИгрока * Математика.Син(Математика.ОтриматиРадіани(кутІгрока))) - ширинаИгрока) / 2.0)
   py1 <- Фігури.ОтриматиВерх(ігрок) - ( (Математика.Модуль(ширинаИгрока * Математика.Син(Математика.ОтриматиРадіани(кутІгрока)) + высотаИгрока * Математика.Кос(Математика.ОтриматиРадіани(кутІгрока))) - высотаИгрока) / 2.0)
