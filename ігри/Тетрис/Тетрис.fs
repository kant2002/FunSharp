...
// GraphicsWindow.DrawResizedImage( Flickr.GetRandomPicture( "bricks" ), 0, 0, GraphicsWindow.Width, GraphicsWindow.Height)
  ...
  ГрафическоеОкно.ШиринаПера <- 1.0
  ГрафическоеОкно.ЦветПера <- Кольори.Pink
  ...
  ГрафическоеОкно.ЦветПера <- Кольори.Lime
  ...
  ГрафическоеОкно.ЦветПера <- Кольори.Black
  ГрафическоеОкно.ЦветКисти <- Кольори.Pink
  ...
  ГрафическоеОкно.ЦветКисти <- Кольори.Black
